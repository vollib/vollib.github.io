...
var Documentation = {
  ...
  fixFirefoxAnchorBug: function fixFirefoxAnchorBug() {
    if (document.location.hash) window.setTimeout(function () {
  ...
  initOnKeyListeners: function initOnKeyListeners() {
    $(document).keyup(function (event) {
      var activeElementType = document.activeElement.tagName; // don't navigate when in search box or textarea
